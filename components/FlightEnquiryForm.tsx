...
export default function FlightEnquiryForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validate()) {
      ...
      const message = `Hi, I'd like to book a flight ticket.%0A%0A *From:* ${formData.from}%0A*To:* ${formData.to}%0A%0A*Date:* ${formattedDate}%0A%0A*Passengers:* ${formData.passengers}`;
